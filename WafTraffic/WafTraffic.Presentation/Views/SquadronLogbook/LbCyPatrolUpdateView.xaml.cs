...
{
    /// <summary>
    /// LbCyPatrolUpdateView.xaml 的交互逻辑
    /// </summary>
    [Export(typeof(ILbCyPatrolUpdateView))]
    public partial class LbCyPatrolUpdateView  : UserControl, ILbCyPatrolUpdateView
    {
        private readonly Lazy<LbCyPatrolUpdateViewModel> viewModel;
        public LbCyPatrolUpdateView()
        {
            InitializeComponent();
            viewModel = new Lazy<LbCyPatrolUpdateViewModel>(() => ViewHelper.GetViewModel<LbCyPatrolUpdateViewModel>(this));

...
namespace WafTraffic.Presentation.Views
{
    ...
    /// </summary>
    [Export(typeof(IZhzxRequestQueryView))]
    public partial class ZhzxRequestQueryView : UserControl, IZhzxRequestQueryView
    {
        private readonly Lazy<ZhzxRequestQueryViewModel> viewModel;

        public ZhzxRequestQueryView()
        {
            InitializeComponent();
            viewModel = new Lazy<ZhzxRequestQueryViewModel>(() => ViewHelper.GetViewModel<ZhzxRequestQueryViewModel>(this));
        ...
        private void gridRequestList_PagingChanged(object sender, CustomControlLibrary.PagingChangedEventArgs args)
        {
            ...
            IQueryable<ZhzxEquipmentRequest> gridTables = viewModel.Value.Requests;

...
namespace DotNet.Utilities
{
    ...
    public class DbHelper
    {
        ...
        //public static int ExecuteNonQuery(string commandText, IDbDataParameter[] dbParameters = null, CommandType commandType = CommandType.Text) //C# 4.0 才支持缺省参数
        public static int ExecuteNonQuery(string commandText, IDbDataParameter[] dbParameters, CommandType commandType)
        {
            int returnValue = 0;
        ...
        public static int ExecuteNonQuery(string commandText)
        {
            ...
            return ExecuteNonQuery(commandText, dbParameters, commandType);
        }

        public static int ExecuteNonQuery(string commandText, IDbDataParameter[] dbParameters)
        {
            CommandType commandType = CommandType.Text;
        ...
        //public static object ExecuteScalar(string commandText, IDbDataParameter[] dbParameters = null, CommandType commandType = CommandType.Text) //C# 4.0 才支持缺省参数
        public static object ExecuteScalar(string commandText, IDbDataParameter[] dbParameters, CommandType commandType)
        {
        ...
        public static object ExecuteScalar(string commandText)
        {
            ...
            return ExecuteScalar(commandText, dbParameters, commandType);
        }

        public static object ExecuteScalar(string commandText, IDbDataParameter[] dbParameters)
        {
            CommandType commandType = CommandType.Text;
        ...
        public static IDataReader ExecuteReader(string commandText, IDbDataParameter[] dbParameters, CommandType commandType)
        {
            dbHelper.Open(DbConnection);
        ...
        public static IDataReader ExecuteReader(string commandText)
        {
            ...
            return ExecuteReader(commandText, dbParameters, commandType);
        }

        public static IDataReader ExecuteReader(string commandText, IDbDataParameter[] dbParameters)
        {
            CommandType commandType = CommandType.Text;
        ...
        public static DataTable Fill(string commandText, IDbDataParameter[] dbParameters, CommandType commandType)
        {
        ...
        public static DataTable Fill(string commandText)
        {
            ...
            return Fill(commandText, dbParameters, commandType);
        }

        public static DataTable Fill(string commandText, IDbDataParameter[] dbParameters)
        {
            CommandType commandType = CommandType.Text;

...
{
    /// <summary>
    /// ZgxcPublicityLogbookQueryView.xaml µÄ½»»¥Âß¼­
    /// </summary>
    [Export(typeof(IZgxcPublicityLogbookQueryView))]
    public partial class ZgxcPublicityLogbookQueryView  : UserControl, IZgxcPublicityLogbookQueryView
    {
        private readonly Lazy<ZgxcPublicityLogbookQueryViewModel> viewModel;
    
        public ZgxcPublicityLogbookQueryView()
        {
            InitializeComponent();
            viewModel = new Lazy<ZgxcPublicityLogbookQueryViewModel>(() => ViewHelper.GetViewModel<ZgxcPublicityLogbookQueryViewModel>(this));
        }
        ...
        private void gridPublicityLogbookList_PagingChanged(object sender, CustomControlLibrary.PagingChangedEventArgs args)
        {
            try
            {
                ...
                IQueryable<ZgxcPublicityLogbook> gridTables = viewModel.Value.ZgxcPublicityLogbooks;

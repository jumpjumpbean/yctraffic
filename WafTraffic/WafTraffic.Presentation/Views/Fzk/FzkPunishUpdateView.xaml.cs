...
{
    /// <summary>
    /// LbZdStaffUpdateView.xaml 的交互逻辑
    /// </summary>
    [Export(typeof(IFzkPunishUpdateView))]
    public partial class FzkPunishUpdateView  : UserControl, IFzkPunishUpdateView
    {
        private readonly Lazy<FzkPunishUpdateViewModel> viewModel;

        public FzkPunishUpdateView()
        {
            InitializeComponent();
            viewModel = new Lazy<FzkPunishUpdateViewModel>(() => ViewHelper.GetViewModel<FzkPunishUpdateViewModel>(this));

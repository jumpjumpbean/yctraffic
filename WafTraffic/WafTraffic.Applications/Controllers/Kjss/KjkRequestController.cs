...
{
    [Export]
    internal class KjkRequestController : Controller
    {
        ...
        private KjkRequestUpdateViewModel mRequestUpdateViewModel;
        private KjkRequestQueryViewModel mRequestQueryViewModel;
        ...
        public KjkRequestController(CompositionContainer container, 
            ...
            IShellService shellService, IEntityService entityService)
        {
            try
            {
                ...
                mRequestUpdateViewModel = container.GetExportedValue<KjkRequestUpdateViewModel>();
                mRequestQueryViewModel = container.GetExportedValue<KjkRequestQueryViewModel>();
        ...
        private void InitStatusList()
        {
            ...
            mStatusList.Add(st);
            st = new Status(YcConstants.INT_KJSS_REQSTAT_BGS_EXECUTE, YcConstants.STR_KJSS_REQSTAT_BGS_EXECUTE);
            mStatusList.Add(st);
        ...
        public bool AddOper()
        {
            ...
            try
            {
                if (!AuthService.Instance.KjkRequestCanAdd)
                {
                ...
                mRequestUpdateViewModel.EquipmentRequestEntity = new KjssEquipmentRequest();
        ...
        public bool QueryOper()
        {
            ...
            try
            {
                ...
                mRequestQueryViewModel.Requests = mEntityService.QueryKjssEquipmentRequests(selectedStatus, startDate, endDate.AddDays(1));
        ...
        public bool SubmitOper()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    mEntityService.Entities.KjssEquipmentRequests.AddObject(mRequestUpdateViewModel.EquipmentRequestEntity);
        ...
        private void GetNextStatus(int curStatus, out int nextStatus, out string nextStatusDesc)
        {
            switch (curStatus)
            {
                ...
                case YcConstants.INT_KJSS_REQSTAT_SUB_LEADER_APPROVE:
                    ...
                    break;
                case YcConstants.INT_KJSS_REQSTAT_DDZ_APPROVE:
                    nextStatus = YcConstants.INT_KJSS_REQSTAT_BGS_EXECUTE;
                    nextStatusDesc = YcConstants.STR_KJSS_REQSTAT_BGS_EXECUTE;
                    break;
                case YcConstants.INT_KJSS_REQSTAT_BGS_EXECUTE:

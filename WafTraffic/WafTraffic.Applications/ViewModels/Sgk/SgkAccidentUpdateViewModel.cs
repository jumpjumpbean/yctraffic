...
{
    [Export]
    public class SgkAccidentUpdateViewModel : LbBaseUpdateViewModel<ISgkAccidentUpdateView>
    {
        #region Data

        private SgkAccidentCase mPunishCaseEntity;
        ...
        public SgkAccidentUpdateViewModel(ISgkAccidentUpdateView view)
            : base(view)
        {
            mPunishCaseEntity = new SgkAccidentCase();
        }
        ...
        public SgkAccidentCase PunishCaseEntity
        {

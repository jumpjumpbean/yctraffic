...
namespace WafTraffic.Presentation.Views
{
    ...
    /// </summary>
    [Export(typeof(IZxkOrderQueryView))]
    public partial class ZxkOrderQueryView : UserControl, IZxkOrderQueryView
    {
        private readonly Lazy<ZxkOrderQueryViewModel> viewModel;

        public ZxkOrderQueryView()
        {
            InitializeComponent();
            viewModel = new Lazy<ZxkOrderQueryViewModel>(() => ViewHelper.GetViewModel<ZxkOrderQueryViewModel>(this));
        ...
        private void gridPunishCaseList_PagingChanged(object sender, CustomControlLibrary.PagingChangedEventArgs args)
        {
            try
            {
                ...
                IQueryable<ZxkOrderCase> gridTables = viewModel.Value.PunishCases;

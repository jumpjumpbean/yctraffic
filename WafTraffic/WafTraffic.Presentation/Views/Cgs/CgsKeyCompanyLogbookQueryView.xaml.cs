...
{
    /// <summary>
    /// CgsKeyCompanyLogbookQueryView.xaml µÄ½»»¥Âß¼­
    /// </summary>
    [Export(typeof(ICgsKeyCompanyLogbookQueryView))]
    public partial class CgsKeyCompanyLogbookQueryView : UserControl, ICgsKeyCompanyLogbookQueryView
    {
        private readonly Lazy<CgsKeyCompanyLogbookQueryViewModel> viewModel;
    
        public CgsKeyCompanyLogbookQueryView()
        {
            InitializeComponent();
            viewModel = new Lazy<CgsKeyCompanyLogbookQueryViewModel>(() => ViewHelper.GetViewModel<CgsKeyCompanyLogbookQueryViewModel>(this));
        }
        ...
        private void gridYellowMarkCarList_PagingChanged(object sender, CustomControlLibrary.PagingChangedEventArgs args)
        {
            try
            {
                ...
                IQueryable<CgsKeyCompanyLogbook> gridTables = viewModel.Value.CgsKeyCompanyLogbooks;

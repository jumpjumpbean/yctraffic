...
{
    /// <summary>
    /// LbCyDangerDealUpdateAfterView.xaml 的交互逻辑
    /// </summary>
    [Export(typeof(ILbCyDangerDealUpdateAfterView))]
    public partial class LbCyDangerDealUpdateAfterView  : UserControl, ILbCyDangerDealUpdateAfterView
    {
        private readonly Lazy<LbCyDangerDealUpdateAfterViewModel> viewModel;
        private const int Type_ContentImg = 1;
        private const int Type_Rectification = 2;
        private const int Type_ReviewImg = 3;

        public LbCyDangerDealUpdateAfterView()
        {
            InitializeComponent();
            viewModel = new Lazy<LbCyDangerDealUpdateAfterViewModel>(() => ViewHelper.GetViewModel<LbCyDangerDealUpdateAfterViewModel>(this));

...
namespace DotNet.Utilities
{
    ...
    public interface IDbHelper : IDisposable
    {
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>结果集流</returns>
        IDataReader ExecuteReader(CommandType commandType, string commandText, IDbDataParameter[] dbParameters);
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>影响行数</returns>
        int ExecuteNonQuery(CommandType commandType, string commandText, IDbDataParameter[] dbParameters);
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>影响行数</returns>
        int ExecuteNonQuery(IDbTransaction dbTransaction, CommandType commandType, string commandText, IDbDataParameter[] dbParameters);
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>Object</returns>
        object ExecuteScalar(CommandType commandType, string commandText, IDbDataParameter[] dbParameters);
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>Object</returns>
        object ExecuteScalar(IDbTransaction dbTransaction, CommandType commandType, string commandText, IDbDataParameter[] dbParameters);
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>数据表</returns>
        DataTable Fill(CommandType commandType, string commandText, IDbDataParameter[] dbParameters);
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>数据表</returns>
        DataTable Fill(DataTable dataTable, CommandType commandType, string commandText, IDbDataParameter[] dbParameters);

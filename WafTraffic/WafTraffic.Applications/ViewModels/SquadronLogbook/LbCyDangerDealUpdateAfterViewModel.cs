...
{
    [Export]
    public class LbCyDangerDealUpdateAfterViewModel : ViewModel<ILbCyDangerDealUpdateAfterView>
    {
        #region Data
        ...
        //private ICommand mShowRectificationCommand;
        //private ICommand mShowReviewCommand;
        //private ICommand mSubLeaderSignCommand;
        ...
        //private BitmapImage mRectificationImg;
        //private BitmapImage mReviewImg;
        ...
        public LbCyDangerDealUpdateAfterViewModel(ILbCyDangerDealUpdateAfterView view)
            : base(view)
        {
        ...
        private ICommand dangerIdSearchCommand;
        public ICommand DangerIdSearchCommand
        {
            get { return dangerIdSearchCommand; }
            set
            {
                if (dangerIdSearchCommand != value)
                {
                    dangerIdSearchCommand = value;
                    RaisePropertyChanged("DangerIdSearchCommand");
                }
            }
        }

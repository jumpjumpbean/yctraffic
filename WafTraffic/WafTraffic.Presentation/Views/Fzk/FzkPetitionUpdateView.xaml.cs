...
{
    /// <summary>
    /// FzkPetitionUpdateView.xaml 的交互逻辑
    /// </summary>
    [Export(typeof(IFzkPetitionUpdateView))]
    public partial class FzkPetitionUpdateView  : UserControl, IFzkPetitionUpdateView
    {
        private readonly Lazy<FzkPetitionUpdateViewModel> viewModel;

        public FzkPetitionUpdateView()
        {
            InitializeComponent();
            viewModel = new Lazy<FzkPetitionUpdateViewModel>(() => ViewHelper.GetViewModel<FzkPetitionUpdateViewModel>(this));
        ...
        private void btnAttachmentNameSelect_Click(object sender, RoutedEventArgs e)
        {
            ...
            viewModel.Value.PetitionEntity.AttachmentName = picName;

...
namespace DotNet.Utilities
{
    ...
    /// 
    /// 修改纪录
    ///     2011.07.06 版本：1.5 sunmiao  修改配置文件后缀为config
    ...
    {
        public static string LogOnTo = "System";
        ...
        public static string ConfigFielName
        {
            get
            {
                ...
                if (appMode.ToLower() == "webapp")
                {
                    return (HttpRuntime.AppDomainAppPath + "Config/" + FileName); 
                }
                else
                {
                ...
                //return FileName;
                //return (ConfigurationManager.AppSettings["ConfigFilePath"] + @"\" + FielName);
            }
        }
        ...
        public static void GetConfig(string fileName)
        {
            ...
            {
                BaseSystemInfo.LogOnAssembly = GetValue(xmlDocument, "LogOnAssembly");
            }
            if (Exists("LogOnForm"))
            {
            ...
            //BaseSystemInfo.ErrorReportMailPassword = SecretUtil.Decrypt(BaseSystemInfo.ErrorReportMailPassword);//暂不加密
        }
        #endregion
        ...
        public static void SaveConfig(string fileName)
        {
            ...
            SetValue(xmlDocument, "LogOnAssembly", BaseSystemInfo.LogOnAssembly);

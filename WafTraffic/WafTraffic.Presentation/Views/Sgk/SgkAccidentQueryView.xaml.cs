...
namespace WafTraffic.Presentation.Views
{
    ...
    /// </summary>
    [Export(typeof(ISgkAccidentQueryView))]
    public partial class SgkAccidentQueryView : UserControl, ISgkAccidentQueryView
    {
        private readonly Lazy<SgkAccidentQueryViewModel> viewModel;

        public SgkAccidentQueryView()
        {
            InitializeComponent();
            viewModel = new Lazy<SgkAccidentQueryViewModel>(() => ViewHelper.GetViewModel<SgkAccidentQueryViewModel>(this));
        ...
        private void gridPunishCaseList_PagingChanged(object sender, CustomControlLibrary.PagingChangedEventArgs args)
        {
            try
            {
                ...
                IQueryable<SgkAccidentCase> gridTables = viewModel.Value.PunishCases;

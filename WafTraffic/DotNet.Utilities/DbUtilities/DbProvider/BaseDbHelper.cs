...
namespace DotNet.Utilities
{
    ...
    public abstract class BaseDbHelper : IDisposable // IDbHelper
    {
        ...
        #region public virtual IDataReader ExecuteReader(CommandType commandType, string commandText, IDbDataParameter[] dbParameters) 执行查询
        /// <summary>
        /// 执行查询
        /// </summary>
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>结果集流</returns>
        public virtual IDataReader ExecuteReader(CommandType commandType, string commandText, IDbDataParameter[] dbParameters)
        {
            // 写入调试信息
            #if (DEBUG)
                int milliStart = Environment.TickCount;
        ...
        #region public virtual int ExecuteNonQuery(CommandType commandType, string commandText) 执行查询
        /// <summary>
        /// 执行查询
        /// </summary>
        /// <param name="commandType">命令分类</param>
        ...
        {
            return this.ExecuteNonQuery(this.dbTransaction, commandType, commandText, null);
        }
        #endregion

        #region public virtual int ExecuteNonQuery(CommandType commandType, string commandText, IDbDataParameter[] dbParameters) 执行查询
        /// <summary>
        /// 执行查询
        /// </summary>
        /// <param name="commandType">命令分类</param>
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>影响行数</returns>
        public virtual int ExecuteNonQuery(CommandType commandType, string commandText, IDbDataParameter[] dbParameters)
        {
            return this.ExecuteNonQuery(this.dbTransaction, commandType, commandText, dbParameters);
        }
        #endregion

        #region public virtual int ExecuteNonQuery(IDbTransaction transaction, CommandType commandType, string commandText, IDbDataParameter[] dbParameters) 执行查询
        /// <summary>
        /// 执行查询
        /// </summary>
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>影响行数</returns>
        public virtual int ExecuteNonQuery(IDbTransaction transaction, CommandType commandType, string commandText, IDbDataParameter[] dbParameters)
        {
            // 写入调试信息
            #if (DEBUG)
                int milliStart = Environment.TickCount;
        ...
        #region public virtual object ExecuteScalar(CommandType commandType, string commandText, IDbDataParameter[] dbParameters) 执行查询
        /// <summary>
        /// 执行查询
        /// </summary>
        /// <param name="commandType">命令分类</param>
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>Object</returns>
        public virtual object ExecuteScalar(CommandType commandType, string commandText, IDbDataParameter[] dbParameters)
        {
            return this.ExecuteScalar(this.dbTransaction, commandType, commandText, dbParameters);
        }
        #endregion

        #region public virtual object ExecuteScalar(IDbTransaction transaction, CommandType commandType, string commandText, IDbDataParameter[] dbParameters) 执行查询
        /// <summary>
        /// 执行查询
        /// </summary>
        /// <param name="transaction">数据库事务</param>
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>Object</returns>
        public virtual object ExecuteScalar(IDbTransaction transaction, CommandType commandType, string commandText, IDbDataParameter[] dbParameters)
        {
            // 写入调试信息
            #if (DEBUG)
                int milliStart = Environment.TickCount;
        ...
        #region public virtual DataTable Fill(CommandType commandType, string commandText, IDbDataParameter[] dbParameters) 填充数据表
        /// <summary>
        /// 填充数据表
        /// </summary>
        /// <param name="commandType">命令分类</param>
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>数据表</returns>
        public virtual DataTable Fill(CommandType commandType, string commandText, IDbDataParameter[] dbParameters)
        {
            DataTable dataTable = new DataTable("DotNet");
        ...
        #region public virtual DataTable Fill(DataTable dataTable, CommandType commandType, string commandText, IDbDataParameter[] dbParameters) 填充数据表
        /// <summary>
        /// 填充数据表
        /// </summary>
        /// <param name="dataTable">目标数据表</param>
        ...
        /// <param name="dbParameters">参数集</param>
        /// <returns>数据表</returns>
        public virtual DataTable Fill(DataTable dataTable, CommandType commandType, string commandText, IDbDataParameter[] dbParameters)
        {
            // 写入调试信息
            #if (DEBUG)
                int milliStart = Environment.TickCount;
        ...
        //public virtual void WriteLog(string commandText, string fileName = null) //C# 4.0 才支持缺省参数
        public virtual void WriteLog(string commandText, string fileName)
        {

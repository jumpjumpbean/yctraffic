...
{
    [Export]
    public class SgkReleaseCarPrintViewModel : ViewModel<ISgkReleaseCarPrintView>
    {
        ...
        public SgkReleaseCarPrintViewModel(ISgkReleaseCarPrintView view, IEntityService entityservice)
            : base(view)
        {

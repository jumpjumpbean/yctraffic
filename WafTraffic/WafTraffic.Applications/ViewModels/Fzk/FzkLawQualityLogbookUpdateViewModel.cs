...
{
    [Export]
    public class FzkLawQualityLogbookUpdateViewModel : ViewModel<IFzkLawQualityLogbookUpdateView>
    {
        #region Data

        private FzkLawQualityLogbook publicityLogbookEntity;
        ...
        public FzkLawQualityLogbookUpdateViewModel(IFzkLawQualityLogbookUpdateView view)
            : base(view)
        {
            publicityLogbookEntity = new FzkLawQualityLogbook();
        }
        ...
        public FzkLawQualityLogbook PublicityLogbookEntity
        {

...
{
    [Export]
    public class SskRequestQueryViewModel : ViewModel<ISskRequestQueryView>
    {
        #region Data

        private SskEquipmentRequest mSelectedRequest = null;
        private IQueryable<SskEquipmentRequest> mRequests = null;
        ...
        public SskRequestQueryViewModel(ISskRequestQueryView view, IEntityService entityservice)
            : base(view)
        {
            try
            {
                this.entityservice = entityservice;
                if (entityservice.EnumSskEquipmentRequests != null)
                {
                    this.mRequests = entityservice.EnumSskEquipmentRequests;
                }
                else
                {
                    this.mRequests = new List<SskEquipmentRequest>().AsQueryable();
                }
            }
        ...
        public IQueryable<SskEquipmentRequest> Requests
        {
            get
            {
                return mRequests;
        ...
        public SskEquipmentRequest SelectedRequest
        {
        ...
        public bool CanAdd
        {
            get { return AuthService.Instance.SskRequestCanAdd; }
        }

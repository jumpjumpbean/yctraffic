...
{
    /// <summary>
    /// QbyqInfoAnalysisQueryView.xaml µÄ½»»¥Âß¼­
    /// </summary>
    [Export(typeof(IQbyqInfoAnalysisQueryView))]
    public partial class QbyqInfoAnalysisQueryView : UserControl, IQbyqInfoAnalysisQueryView
    {
        private readonly Lazy<QbyqInfoAnalysisQueryViewModel> viewModel;

        public QbyqInfoAnalysisQueryView()
        {
            InitializeComponent();
            viewModel = new Lazy<QbyqInfoAnalysisQueryViewModel>(() => ViewHelper.GetViewModel<QbyqInfoAnalysisQueryViewModel>(this));
        ...
        private void gridPunishCaseList_PagingChanged(object sender, CustomControlLibrary.PagingChangedEventArgs args)
        {
            try
            {
                ...
                IQueryable<QbyqInfoAnalysisCase> gridTables = viewModel.Value.PunishCases;

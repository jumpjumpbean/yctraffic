...
{
    /// <summary>
    /// CgsYellowMarkCarQueryView.xaml µÄ½»»¥Âß¼­
    /// </summary>
    [Export(typeof(ICgsYellowMarkCarQueryView))]
    public partial class CgsYellowMarkCarQueryView : UserControl, ICgsYellowMarkCarQueryView
    {
        private readonly Lazy<CgsYellowMarkCarQueryViewModel> viewModel;
    
        public CgsYellowMarkCarQueryView()
        {
            InitializeComponent();
            viewModel = new Lazy<CgsYellowMarkCarQueryViewModel>(() => ViewHelper.GetViewModel<CgsYellowMarkCarQueryViewModel>(this));
        }
        ...
        private void gridYellowMarkCarList_PagingChanged(object sender, CustomControlLibrary.PagingChangedEventArgs args)
        {
            try
            {
                ...
                IQueryable<CgsYellowMarkCar> gridTables = viewModel.Value.CgsYellowMarkCars;

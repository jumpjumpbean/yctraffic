namespace DotNet.Business
{
    ...
    [Serializable]
    public class BaseWorkFlowActivityEntity
    {
        ...
        [NonSerialized]
        public static string TableName = "Base_WorkFlowActivity";
        ...
        public BaseWorkFlowActivityEntity GetFrom(DataTable dataTable)
        {

...
{
    /// <summary>
    /// ZxkOrderUpdateView.xaml 的交互逻辑
    /// </summary>
    [Export(typeof(IZxkOrderUpdateView))]
    public partial class ZxkOrderUpdateView  : UserControl, IZxkOrderUpdateView
    {
        private readonly Lazy<ZxkOrderUpdateViewModel> viewModel;

        public ZxkOrderUpdateView()
        {
            InitializeComponent();
            viewModel = new Lazy<ZxkOrderUpdateViewModel>(() => ViewHelper.GetViewModel<ZxkOrderUpdateViewModel>(this));
        ...
        private void btnAttachmentNameSelect_Click2(object sender, RoutedEventArgs e)
        {
            string picName;
            string localPath;
            UploadPicture(out localPath, out picName);

            this.tbAttachFileName2.Text = picName;
            viewModel.Value.PunishCaseEntity.AttachmentName2 = picName;
            viewModel.Value.FileLocalPath2 = localPath;
        }

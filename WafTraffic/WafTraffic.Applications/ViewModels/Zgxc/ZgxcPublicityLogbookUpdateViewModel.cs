...
{
    [Export]
    public class ZgxcPublicityLogbookUpdateViewModel : ViewModel<IZgxcPublicityLogbookUpdateView>
    {
        #region Data

        private ZgxcPublicityLogbook publicityLogbookEntity;
        ...
        public ZgxcPublicityLogbookUpdateViewModel(IZgxcPublicityLogbookUpdateView view)
            : base(view)
        {
            publicityLogbookEntity = new ZgxcPublicityLogbook();
        }
        ...
        public ZgxcPublicityLogbook PublicityLogbookEntity
        {
            ...
            set
            {
                if (publicityLogbookEntity != value)
                {
                    ...
                    RaisePropertyChanged("PublicityLogbookEntity");
                }
            }
        }

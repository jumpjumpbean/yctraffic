...
{
    [Export]
    internal class FzkLawQualityLogbookController : Controller
    {
        ...
        private FzkLawQualityLogbookUpdateViewModel logbookUpdateViewModel;
        private FzkLawQualityLogbookQueryViewModel logbookQueryViewModel;
        ...
        public FzkLawQualityLogbookController(CompositionContainer container, 
            ...
            IShellService shellService, IEntityService entityService)
        {
            try
            {
                ...
                logbookUpdateViewModel = container.GetExportedValue<FzkLawQualityLogbookUpdateViewModel>();
                logbookQueryViewModel = container.GetExportedValue<FzkLawQualityLogbookQueryViewModel>();
        ...
        public bool NewOper()
        {
            ...
            try
            {
                ...
                logbookUpdateViewModel.PublicityLogbookEntity = new FzkLawQualityLogbook();
        ...
        public bool QueryOper()
        {
            ...
            try
            {
                logbookQueryViewModel.FzkLawQualityLogbooks = mEntityService.QueryableLawQualityLogbooks.Where<FzkLawQualityLogbook>
                (
                    entity =>
                ...
                if (logbookQueryViewModel.FzkLawQualityLogbooks == null || logbookQueryViewModel.FzkLawQualityLogbooks.Count() == 0)
                {
        ...
        private void worker_Save(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    mEntityService.Entities.FzkLawQualityLogbooks.AddObject(logbookUpdateViewModel.PublicityLogbookEntity);
                }
                mEntityService.Entities.SaveChanges();
                e.Result = true;
            }

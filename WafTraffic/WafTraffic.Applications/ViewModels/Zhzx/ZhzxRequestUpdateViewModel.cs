...
{
    [Export]
    public class ZhzxRequestUpdateViewModel : ViewModel<IZhzxRequestUpdateView>
    {
        #region Data

        private ZhzxEquipmentRequest mEntity = null;
        ...
        public ZhzxRequestUpdateViewModel(IZhzxRequestUpdateView view)
            : base(view)
        {
            mEntity = new ZhzxEquipmentRequest();
        }
        ...
        public ZhzxEquipmentRequest EquipmentRequestEntity
        {
            get { return mEntity; }
            set
            {
                ...
                //{
                    ...
                    RaisePropertyChanged("IsBgsInfoReadOnly");
                    RaisePropertyChanged("IsBgsInfoVisible");
        ...
        public bool IsBaseInfoReadOnly
        {
            get 
            {
                if (mEntity != null)
                {
                    return (mIsBrowse || mEntity.Status >= YcConstants.INT_ZHZX_REQSTAT_SUB_LEADER_APPROVE);
                }
                else
                {
                    return mIsBrowse; 
        ...
        public bool IsSubLeaderInfoReadOnly
        {
            get
            {
                if (mEntity != null)
                {
                    return (mIsBrowse || mEntity.Status >= YcConstants.INT_ZHZX_REQSTAT_DDZ_APPROVE);
                }
                else
                {
                    return mIsBrowse;
        ...
        public bool IsSubLeaderInfoVisible
        {
            get
            {
                if (mEntity != null)
                {
                    if (mIsBrowse)
                    {
                        return (mEntity.Status >= YcConstants.INT_ZHZX_REQSTAT_DDZ_APPROVE);
                    }
                    else
                    {
                        return (mEntity.Status >= YcConstants.INT_ZHZX_REQSTAT_SUB_LEADER_APPROVE);
                    }
                }
                else
                {
        ...
        public bool IsDdzInfoReadOnly
        {
            get
            {
                if (mEntity != null)
                {
                    return (mIsBrowse || mEntity.Status >= YcConstants.INT_ZHZX_REQSTAT_ZHZX_EXECUTE);
                }
                else
                {
                    return mIsBrowse;
        ...
        */
        ...
        public bool IsSubLeaderSignButtonVisible
        {
            get
            {
                ...
                if (mEntity != null)
                {
                    if (mEntity.Status == YcConstants.INT_ZHZX_REQSTAT_SUB_LEADER_APPROVE)
                    {
                        return true;
                    }
                }
        ...
        public bool IsDdzSignButtonVisible
        {
            get
            {
                ...
                if (mEntity != null)
                {
                    if (mEntity.Status == YcConstants.INT_ZHZX_REQSTAT_DDZ_APPROVE)
                    {
                        return true;
                    }
                }
        ...
        public bool IsBgsInfoReadOnly
        {
            get
            {
                if (mEntity != null)
                {
                    return (mIsBrowse || mEntity.Status == YcConstants.INT_ZHZX_REQSTAT_COMPLETED);
                }
                else
                {
                    return mIsBrowse;
        ...
        public bool IsBgsInfoVisible
        {
            get
            {
                if (mEntity != null)
                {
                    if (mIsBrowse)
                    {
                        return (mEntity.Status == YcConstants.INT_ZHZX_REQSTAT_COMPLETED);
                    }
                    else
                    {
                        return (mEntity.Status >= YcConstants.INT_ZHZX_REQSTAT_BGS_EXECUTE);
                    }
                }
                else
                {
        ...
        public bool IsRejectButtonVisible
        {
            get
            {
                ...
                if (mEntity != null)
                {
                    if (mEntity.Id > 0 && mEntity.Status > YcConstants.INT_ZHZX_REQSTAT_NULL)
                    {
                        return true;
                    }   
                }

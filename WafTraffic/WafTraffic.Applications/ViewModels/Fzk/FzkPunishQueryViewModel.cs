...
{
    [Export]
    public class FzkPunishQueryViewModel : ViewModel<IFzkPunishQueryView>
    {
        #region Data

        private FzkPunishCase mSelectedCase;
        private IQueryable<FzkPunishCase> mPunishCases;
        ...
        public FzkPunishQueryViewModel(IFzkPunishQueryView view, IEntityService entityservice)
            : base(view)
        {
            if (entityservice.EnumFzkPunishCases != null)
            {
                this.mPunishCases = entityservice.EnumFzkPunishCases;
            }
            else
            {
                this.mPunishCases = new List<FzkPunishCase>().AsQueryable(); //以防没有数据时出现异常
            }
        ...
        public IQueryable<FzkPunishCase> PunishCases
        {
            get
            {
                return mPunishCases;
        ...
        public FzkPunishCase SelectedCase
        {

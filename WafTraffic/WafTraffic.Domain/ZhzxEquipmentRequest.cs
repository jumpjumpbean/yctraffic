...
{
    public partial class ZhzxEquipmentRequest
    {
        ...
        public bool CanBrowse
        {
            get
            {
                mCanBrowse = AuthUtil.Instance.ZhzxRequestCanBrowse;
                return mCanBrowse;
            }
        }
        ...
        public bool CanModify
        {
            get
            {
                ...
                if (this.Status == YcConstantTable.INT_ZHZX_REQSTAT_SUB_LEADER_APPROVE
                    && CurrentLoginService.Instance.CurrentUserInfo.RealName == this.Applicant
                    && AuthUtil.Instance.ZhzxRequestCanModify)
                {
                    mCanModify = true;
                }
                else
        ...
        public bool CanDelete
        {
            get
            {
                if (this.Status == YcConstantTable.INT_ZHZX_REQSTAT_SUB_LEADER_APPROVE
                    && CurrentLoginService.Instance.CurrentUserInfo.RealName == this.Applicant
                    && AuthUtil.Instance.ZhzxRequestCanDelete)
                {
                    mCanDelete = true;
                }
                else
